  ...
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <iframe
        src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d224.63560433171278!2d89.24766155959841!3d25.7319020958687!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1724878513623!5m2!1sen!2sbd"
        className="border-0 w-full max-w-4xl h-56"
        allowFullScreen=""
        loading="lazy"
